            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/seo/pages/add','ADD PAGE Button Click');">ADD PAGE</button>
                    </div>
                </div>
            </div>
            <div class="row clearfix">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable" id="metaTable">
                                    <thead>
                                        <tr>
                                            <th>Sr.No</th>
                                            <th>Upload Time</th>
                                            ...
                                            <th>Page</th>
                                            <th>Meta Title</th>
                                            <th>Meta Title Characters</th>
                                            <th>Meta Descriptions</th>
                                            <th>Meta Descriptions Characters</th>
                                            <th>Meta Keyword</th>
