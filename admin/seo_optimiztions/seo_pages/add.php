            ...
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-10 d-flex align-items-center">
                    ...
                    <ul class="breadcrumb p-l-0 p-b-0">
                        ...
                        <li class="breadcrumb-item active">New Pages</li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/seo/pages','Add Seo ON Pages Back Button Click View clients Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
