            ...
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-10 d-flex align-items-center">
                    ...
                    <ul class="breadcrumb p-l-0 p-b-0">
                        ...
                        <li class="breadcrumb-item active">Edit Technical</li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/seo/technical','Edit Seo Code Insert Back Button Click View clients Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" class="form-control" cols="30" rows="5" placeholder="Enter Technical Code"></textarea>
                                    </div>
                                </div>
                            </div>
