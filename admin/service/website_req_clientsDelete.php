...
// Handle POST request for client deletion
        ...
        if ($row) {
            ...
            if ($stmtDelete->execute()) {
                ...
                if ($rowCount > 0) {
                    ...
                    log_action($user_id, "Delete Clients Name ".$row['name']." In Database");
                    echo json_encode(['success' => true, 'message' => 'Client deleted successfully.']);
                    exit;
                } else {
                    echo json_encode(['success' => false, 'message' => 'Unable to delete the client.']);
                    exit;
                }
            } else {
