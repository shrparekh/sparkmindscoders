            ...
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-10 d-flex align-items-center">
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item active">Add Frequently Asked Questions</li>
                    </ul>
                </div>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12 pt-2">
                                    <label for="">Frequently Asked Questions Tags</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Frequently Asked Questions" name="name" id="faq_name" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6 d-flex align-items-end">
                                    ...
                                    <button class="btn btn-primary p-2">Add FAQ</button>
                                </div>
                            </div>
