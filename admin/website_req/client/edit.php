            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/website/clients','Edit Clients Back Button Click View clients Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
