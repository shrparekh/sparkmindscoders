            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/website/testimonial','Edit testimonial Back Button Click View testimonial Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="comment" class="form-control" placeholder="Enter Testimonial Comment"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="card">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Testimonial Image Alt" name="image_alt" />
                                    </div>
                                </div>
                                <div class="col-sm-6">
