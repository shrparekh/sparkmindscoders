            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/website/testimonial','Add testimonial Back Button Click View testimonial Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
