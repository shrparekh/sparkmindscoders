            ...
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-10 d-flex align-items-center">
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item active">Add List of companies</li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/website/companies','Add companies Back Button Click View companies Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
