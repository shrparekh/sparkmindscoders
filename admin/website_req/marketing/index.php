            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/website/companies/add','ADD COMPANIES Button Click');">ADD COMPANIES</button>
                    </div>
                </div>
            </div>
            <div class="row clearfix">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable" id="companiesTable">
                                    <thead>
                                        <tr>
                                            <th>Sr.No</th>
                                            <th>Upload Time</th>
