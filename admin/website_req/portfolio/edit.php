...
<section class="content blog-page">
    <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/website/portfolio','Edit portfolio Back Button Click View portfolio Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form id="portfolio_edit">
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">Name :</label>
                                        <input type="text" class="form-control" placeholder="Enter Portfolio Name" name="name" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="card">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Portfolio Image Alt" name="image_alt" />
                                    </div>
                                </div>
                                <div class="col-sm-6">
