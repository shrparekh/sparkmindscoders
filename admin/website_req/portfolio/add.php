            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/website/portfolio','Add portfolio Back Button Click View portfolio Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
