            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/post/tags','Add tags Back Button Click View tags Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <input type="hidden" id="user" name="user_id" value="<?php echo $_SESSION["user_id"] ?>">
                                    <button class="btn btn-primary p-2"> Add Tag</button>
                                </div>
                            </div>
