            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 ">
                    <div class="input-group m-b-0">
                        <button class="btn btn-default" type="button" onclick="logAndNavigate(event, '/admin/posts','Edit Posts Back Button Click View Posts Page');">Back</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form id="posts_edit">
                        ...
                        <div class="row clearfix">
                                ...
                                <div class="col-md-6 pt-3">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            ...
                                            <img id="img-preview" src="#" alt="Preview" style="max-width: 100%;">
                            ...
                            <div>
                                ...
                                <button class="btn btn-primary p-2"> Update Post</button>
                            </div>
